...
export DOCKER_TAG="version-${VERSION}"
...
export INGESTION_REST_ENDPOINT=http://localhost:52773/csp/app/rest
export INGESTION_REST_SCHEMA_VERSION=v1
export INGESTION_REST_USERNAME=SuperUser
export INGESTION_REST_PASSWORD=sys
