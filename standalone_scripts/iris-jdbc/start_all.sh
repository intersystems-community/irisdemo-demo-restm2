...
printf "${PURPLE}\n"
echo '********************************************************************************'
echo 'Starting IRIS REST Ingestion Worker'
echo '********************************************************************************'
printf "${NOCOLOR}\n"
...
docker run --init -d --rm --name iris_htap -p 51773:51773 -p 52773:52773 intersystemsdc/irisdemo-demo-restm2:iris-data-sink-${DOCKER_TAG}
